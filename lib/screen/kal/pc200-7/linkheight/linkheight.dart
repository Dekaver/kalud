...
class LinkHeightPage extends StatefulWidget {
  @override
  _LinkHeightPageState createState() => _LinkHeightPageState();
}

class _LinkHeightPageState extends State<LinkHeightPage> {
  ...
  final TextEditingController standarSizeText =
      TextEditingController(text: '105');
  final TextEditingController repairLimitText =
      TextEditingController(text: '97');
