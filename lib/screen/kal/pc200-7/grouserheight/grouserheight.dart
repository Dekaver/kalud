...
class GrouserHeightPage extends StatefulWidget {
  @override
  _GrouserHeightPageState createState() => _GrouserHeightPageState();
}

class _GrouserHeightPageState extends State<GrouserHeightPage> {
  ...
  final TextEditingController faktorText = TextEditingController(text: '1.0');
