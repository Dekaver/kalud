...
class CarrierRollerPage extends StatefulWidget {
  @override
  _CarrierRollerPageState createState() => _CarrierRollerPageState();
}

class _CarrierRollerPageState extends State<CarrierRollerPage> {
  ...
  final TextEditingController repairLimitText =
      TextEditingController(text: '106');
