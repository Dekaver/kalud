...
class IDLERPage extends StatefulWidget {
  @override
  _IDLERPageState createState() => _IDLERPageState();
}

class _IDLERPageState extends State<IDLERPage> {
  ...
  final TextEditingController faktorText = TextEditingController(text: '1.8');
