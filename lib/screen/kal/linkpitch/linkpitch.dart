...
class LinkPitchPage extends StatefulWidget {
  @override
  _LinkPitchPageState createState() => _LinkPitchPageState();
}

class _LinkPitchPageState extends State<LinkPitchPage> {
  ...
  final TextEditingController standarSizeText =
      TextEditingController(text: '190.25');
  final TextEditingController repairLimitText =
      TextEditingController(text: '194.25');
  final TextEditingController faktorText = TextEditingController(text: '1.3');
